...
furnace, operating with a hydrogen (H₂) atmosphere. The simulation is initialised at stagnant flow 
...
The plasma property dataset for H₂ must be generated using 
[minplascalc](https://github.com/quinnreynolds/minplascalc) and placed in `constant/dataH2/`
before running (see dataH2/ directory for required file names).
